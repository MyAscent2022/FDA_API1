...
public class InspectionController {
  ...
  public ApiResponseModel searcSched(@RequestParam("inspection_sched") String inspection_sched) {
    return inspectionServiceImp.getInspectionSched(inspection_sched);
  }
